    ...
    <div>
      <div v-if="showSearch" class="filter-container">
        <el-form :inline="true" :model="listQuery" label-width="auto">
          <el-form-item label="规则名称 ">
            <el-input v-model="listQuery.ruleName" placeholder="请输入规则名称 " />
          </el-form-item>
          <el-form-item label="规则类型 1 人员规则 ">
            <el-select v-model="listQuery.ruleType" clearable filterable placeholder="请选择">
              <el-option key="深圳" label="选项1" value="深圳" />
              <el-option key="上海" label="选项2" value="上海" />
            </el-select>
          </el-form-item>
      ...
      <div class="table-container">
        ...
        <el-table v-loading="listLoading" :data="list" size="mini" element-loading-text="Loading" fit border highlight-current-row>
          ...
          <el-table-column v-if="columns[0].visible" label="规则 guid " prop="ruleId" align="center" sortable :show-overflow-tooltip="true" />
          <el-table-column v-if="columns[1].visible" label="规则名称 " prop="ruleName" align="center" sortable :show-overflow-tooltip="true" />
          <el-table-column v-if="columns[2].visible" label="规则编号 " prop="ruleCode" align="center" sortable :show-overflow-tooltip="true" />
          <el-table-column v-if="columns[3].visible" label="规则类型 1 人员规则 " prop="ruleType" align="center" sortable :show-overflow-tooltip="true" />
          <el-table-column v-if="columns[4].visible" label="租户编号 " prop="tenantId" align="center" sortable :show-overflow-tooltip="true" />
          <el-table-column v-if="columns[5].visible" label="流程编号 " prop="processId" align="center" sortable :show-overflow-tooltip="true" />
          <el-table-column v-if="columns[6].visible" label="角色组编号 " prop="roleGroupId" align="center" sortable :show-overflow-tooltip="true" />
          <el-table-column v-if="columns[7].visible" label="角色编号 " prop="roleId" align="center" sortable :show-overflow-tooltip="true" />
          <el-table-column v-if="columns[8].visible" label="用户编号 " prop="userId" align="center" sortable :show-overflow-tooltip="true" />
          <el-table-column v-if="columns[9].visible" label="规则表达式 " prop="ruleExpression" align="center" sortable :show-overflow-tooltip="true" />
          <el-table-column v-if="columns[10].visible" label="规则动作 " prop="ruleAction" align="center" sortable :show-overflow-tooltip="true" />
          <el-table-column v-if="columns[11].visible" label="人员工号 " prop="ruleUsers" align="center" sortable :show-overflow-tooltip="true" />
          <el-table-column v-if="columns[12].visible" label="备注 " prop="remarks" align="center" sortable :show-overflow-tooltip="true" />
          ...
          <el-table-column v-if="columns[14].visible" label="操作工号 " prop="operatorId" align="center" sortable :show-overflow-tooltip="true" />
          <el-table-column v-if="columns[15].visible" label="操作姓名 " prop="operatorName" align="center" sortable :show-overflow-tooltip="true" />
      ...
      <el-dialog :title="titleMap[dialogStatus]" :visible.sync="dialogVisible" width="40%" :before-close="handleClose" @close="handleDialogClose">
        <el-form ref="dataForm" :model="form" :rules="rules" label-width="auto" class="demo-ruleForm">
          <el-form-item v-if="true" label="规则 guid :" prop="ruleId">
            <el-input v-model="form.ruleId" disabled />

          </el-form-item>
          <el-form-item v-if="true" label="规则名称 :" prop="ruleName">
            <el-input
              v-model="form.ruleName"
              placeholder="请输入规则名称 "
            />
          </el-form-item>
          <el-form-item v-if="true" label="规则编号 :" prop="ruleCode">
            <el-input
              v-model="form.ruleCode"
              placeholder="请输入规则编号 "
            />
          </el-form-item>
          <el-form-item v-if="true" label="规则类型 1 人员规则 :" prop="ruleType">
          ...
          <el-form-item v-if="true" label="角色组编号 :" prop="roleGroupId">
            <el-input-number
              v-model="form.roleGroupId"
              placeholder="请输入角色组编号 "
            />
          </el-form-item>
          <el-form-item v-if="true" label="角色编号 :" prop="roleId">
            <el-input-number
              v-model="form.roleId"
              placeholder="请输入角色编号 "
            />
          ...
          <el-form-item v-if="true" label="规则表达式 :" prop="ruleExpression">
            <el-input
              v-model="form.ruleExpression"
              placeholder="请输入规则表达式 "
            />
          </el-form-item>
          <el-form-item v-if="true" label="规则动作 :" prop="ruleAction">
            <el-input
              v-model="form.ruleAction"
              placeholder="请输入规则动作 "
            />
          </el-form-item>
          <el-form-item v-if="true" label="人员工号 :" prop="ruleUsers">
            <el-input
          ...
          <el-form-item v-if="true" label="操作工号 :" prop="operatorId">
            <el-input-number
              v-model="form.operatorId"
              placeholder="请输入操作工号 "
            />
          </el-form-item>
          <el-form-item v-if="true" label="操作姓名 :" prop="operatorName">
            <el-input
              v-model="form.operatorName"
              placeholder="请输入操作姓名 "
            />
          </el-form-item>
          <el-form-item v-if="true" label="创建时间 :" prop="createTime">
            <el-date-picker v-model="form.createTime" type="date" placeholder="请输入创建时间 " />
          </el-form-item>
          <el-form-item v-if="true" label="更新时间 :" prop="updateTime">
      ...
      <el-dialog :title="titleMap[dialogStatus]" :visible.sync="updateDialogVisible" width="40%" :before-close="handleClose" @close="handleDialogClose">
        <el-form ref="updateDataForm" :model="updateForm" :rules="updateRules" label-width="auto" class="demo-ruleForm">
          <el-form-item v-if="true" label="规则 guid :" prop="ruleId">
            <el-input v-model="updateForm.ruleId" disabled />
          ...
          <el-form-item v-if="true" label="规则类型 1 人员规则 :" prop="ruleType">
            <el-select v-model="updateForm.ruleType" placeholder="请选择">
              <el-option key="深圳" label="选项1" value="深圳" />
              <el-option key="上海" label="选项2" value="上海" />
            </el-select>
          </el-form-item>
...
<script>
import { getProcessRuleListPage, saveProcessRule, updateProcessRule, deleteById, download } from '@/api/process/processRule'
...
export default {
  ...
  data() {
    return {
      ...
      columns: [
        ...
        { key: 3, value: 'ruleType', label: '规则类型 1 人员规则 ', visible: true },
        ...
        { key: 9, value: 'ruleExpression', label: '规则表达式 ', visible: true },
  ...
  methods: {
    getList() {
      ...
      getProcessRuleListPage(this.listQuery).then(response => {
        ...
        if (valid) {
          this.$confirm('确定操作吗?', '提示', {
            ...
            if (_this.dialogStatus === 'create') {
              saveProcessRule(_this.form).then(response => {
                if (response.code === 200) {
                  _this.getList()
              ...
              updateProcessRule(_this.updateForm).then(response => {
                if (response.code === 200) {
                  _this.getList()
                  _this.$message.success(response.message)
