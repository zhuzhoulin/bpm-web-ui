    ...
    <div>
      ...
      >
        ...
        >
          ...
          >
            <el-input
              v-model="form.selectItem"
              placeholder="请输入SELECT 下拉选项 "
            />
          </el-form-item>
          <el-form-item
            v-if="true"
      ...
      >
        ...
        >
          ...
          >
            <el-input
              v-model="updateForm.stringValue"
              placeholder="请输入字符串数据值 "
            />
          </el-form-item>
          <el-form-item
          ...
          >
            <el-switch
              v-model="updateForm.booleanValue"
              :active-value="1"
              :inactive-value="0"
            />
          </el-form-item>
          ...
          >
            <el-input
              v-model="updateForm.numberValue"
              placeholder="请输入数值值 "
            />
          </el-form-item>
          <el-form-item
          ...
          >
            <el-input
              v-model="updateForm.numberFormat"
              placeholder="请输入日期格式 "
            />
          </el-form-item>
          <el-form-item
          ...
          >
            <el-input
              v-model="updateForm.datePattern"
              placeholder="请输入日期格式 "
            />
          </el-form-item>
          <el-form-item
          ...
          >
            <el-input
              v-model="updateForm.selectValue"
              placeholder="请输入select 选中值 "
            />
          </el-form-item>
          <el-form-item
...
export default {
  ...
  methods: {
    getList() {
      ...
      getFormDataListPage(this.listQuery)
        .then((response) => {
        ...
        if (valid) {
          this.$confirm('确定操作吗?', '提示', {
            ...
            if (_this.dialogStatus === 'create') {
              ...
              updateFormData(_this.updateForm)
                .then((response) => {
                  if (response.code === 200) {
                    _this.getList()
                    _this.$message.success(response.message)
