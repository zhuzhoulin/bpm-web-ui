    ...
    <div>
      <div v-if="showSearch" class="filter-container">
        <el-form :inline="true" :model="listQuery" label-width="auto">
          <el-form-item label="公司编号 ">
            <el-input v-model="listQuery.companyId" placeholder="请输入公司编号 " />
          </el-form-item>
          <el-form-item label="公司编码 ">
            <el-input v-model="listQuery.companyCode" placeholder="请输入公司编码 " />
          </el-form-item>
          <el-form-item label="上级公司编号 ">
            <el-input v-model="listQuery.companyParentId" placeholder="请输入上级公司编号 " />
          </el-form-item>
      ...
      <div class="table-container">
        ...
        <el-table v-loading="listLoading" :data="list" size="mini" element-loading-text="Loading" fit border highlight-current-row>
          ...
          <el-table-column v-if="columns[0].visible" label="公司编号 " prop="companyId" align="center" sortable :show-overflow-tooltip="true" />
          <el-table-column v-if="columns[1].visible" label="公司编码 " prop="companyCode" align="center" sortable :show-overflow-tooltip="true" />
          <el-table-column v-if="columns[2].visible" label="上级公司编号 " prop="companyParentId" align="center" sortable :show-overflow-tooltip="true" />
          <el-table-column v-if="columns[3].visible" label="上级公司编码 " prop="companyParentCode" align="center" sortable :show-overflow-tooltip="true" />
          <el-table-column v-if="columns[4].visible" label="公司名称 " prop="companyName" align="center" sortable :show-overflow-tooltip="true" />
          <el-table-column v-if="columns[5].visible" label="公司简称 " prop="companyAbbr" align="center" sortable :show-overflow-tooltip="true" />
          <el-table-column v-if="columns[6].visible" label="公司层级 " prop="companyLevel" align="center" sortable :show-overflow-tooltip="true" />
          <el-table-column v-if="columns[7].visible" label="排序 " prop="companyOrder" align="center" sortable :show-overflow-tooltip="true" />
          <el-table-column v-if="columns[8].visible" label="公司展示图标 " prop="companyIcon" align="center" sortable :show-overflow-tooltip="true" />
          <el-table-column v-if="columns[9].visible" label="公司展示url " prop="companyUrl" align="center" sortable :show-overflow-tooltip="true" />
          <el-table-column v-if="columns[10].visible" label="租户编号 " prop="tenantId" align="center" sortable :show-overflow-tooltip="true" />
          <el-table-column v-if="columns[11].visible" label="经营状态 " prop="companyStatus" align="center" sortable :show-overflow-tooltip="true" />
          <el-table-column v-if="columns[12].visible" label="状态" prop="validState" align="center">
            <template slot-scope="scope">
          ...
          <el-table-column v-if="columns[13].visible" label="操作人工号 " prop="operatorId" align="center" sortable :show-overflow-tooltip="true" />
          <el-table-column v-if="columns[14].visible" label="操作人姓名 " prop="operatorName" align="center" sortable :show-overflow-tooltip="true" />
          <el-table-column v-if="columns[15].visible" label="创建时间" align="center">
            <template slot-scope="scope">
              <span>{{ scope.row.createTime }}</span>
            </template>
          </el-table-column>
          <el-table-column v-if="columns[16].visible" label="更新时间" align="center">
            <template slot-scope="scope">
      ...
      <el-dialog :title="titleMap[dialogStatus]" :visible.sync="dialogVisible" width="40%" @close="handleDialogClose">
        <el-form ref="dataForm" :model="form" :rules="rules" label-width="auto" class="demo-ruleForm">
          ...
          <el-form-item v-if="true" label="上级公司编号 :" prop="companyParentId">
            <el-input
              v-model="form.companyParentId"
              placeholder="请输入上级公司编号 "
            />
          </el-form-item>
          <el-form-item v-if="true" label="上级公司编码 :" prop="companyParentCode">
            <el-input
              v-model="form.companyParentCode"
              placeholder="请输入上级公司编码 "
            />
          </el-form-item>
          <el-form-item v-if="true" label="公司名称 :" prop="companyName">
            <el-input
              v-model="form.companyName"
              placeholder="请输入公司名称 "
            />
          </el-form-item>
          <el-form-item v-if="true" label="公司简称 :" prop="companyAbbr">
            <el-input
              v-model="form.companyAbbr"
              placeholder="请输入公司简称 "
            />
          </el-form-item>
          <el-form-item v-if="true" label="公司层级 :" prop="companyLevel">
            <el-input
              v-model="form.companyLevel"
              placeholder="请输入公司层级 "
            />
          </el-form-item>
          <el-form-item v-if="true" label="排序 :" prop="companyOrder">
            <el-input
              v-model="form.companyOrder"
              placeholder="请输入排序 "
            />
          </el-form-item>
          <el-form-item v-if="true" label="公司展示图标 :" prop="companyIcon">
            <el-input
              v-model="form.companyIcon"
              placeholder="请输入公司展示图标 "
            />
          </el-form-item>
          <el-form-item v-if="true" label="公司展示url :" prop="companyUrl">
            <el-input
          ...
          <el-form-item v-if="true" label="经营状态 :" prop="companyStatus">
            <el-input
              v-model="form.companyStatus"
              placeholder="请输入经营状态 "
            />
          </el-form-item>
          <el-form-item v-if="false" label="有效状态；0表示无效，1表示有效 :" prop="validState">
      ...
      <el-dialog :title="titleMap[dialogStatus]" :visible.sync="updateDialogVisible" width="40%" @close="handleDialogClose">
        <el-form ref="updateDataForm" :model="updateForm" :rules="updateRules" label-width="auto" class="demo-ruleForm">
          <el-form-item v-if="true" label="公司编号 :" prop="companyId">
            <el-input v-model="updateForm.companyId" disabled />
...
<script>
import { getCompanyListPage, saveCompany, updateCompany, deleteById, download } from '@/api/system/company'
...
export default {
  ...
  data() {
    return {
      ...
      columns: [
        ...
        { key: 2, value: 'companyParentId', label: '上级公司编号 ', visible: true },
        { key: 3, value: 'companyParentCode', label: '上级公司编码 ', visible: true },
        ...
        { key: 12, value: 'validState', label: '有效状态；0表示无效，1表示有效 ', visible: true },
  ...
  methods: {
    getList() {
      ...
      getCompanyListPage(this.listQuery).then(response => {
        ...
        if (valid) {
          this.$confirm('确定操作吗?', '提示', {
            ...
            if (_this.dialogStatus === 'create') {
              saveCompany(_this.form).then(response => {
                if (response.code === 200) {
                  _this.getList()
              ...
              updateCompany(_this.updateForm).then(response => {
                if (response.code === 200) {
                  _this.getList()
                  _this.$message.success(response.message)
