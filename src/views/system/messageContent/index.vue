    ...
    <div>
      <div v-if="showSearch" class="filter-container">
        <el-form :inline="true" :model="listQuery" label-width="auto">
          <el-form-item label="内容编码 ">
            <el-input v-model="listQuery.contentCode" placeholder="请输入内容编码 " />
          </el-form-item>
          <el-form-item label="租户编号 ">
            <el-input v-model="listQuery.tenantId" placeholder="请输入租户编号 " />
          </el-form-item>
          <el-form-item label="通知标题 ">
            <el-input v-model="listQuery.messageTitle" placeholder="请输入通知标题 " />
          </el-form-item>
          <el-form-item label="通知类型 ">
            <el-input v-model="listQuery.messageTypeCode" placeholder="请输入通知类型 " />
          </el-form-item>
          <el-form-item label="触发事件编码 ">
            <el-input v-model="listQuery.eventCodes" placeholder="请输入触发事件编码 " />
          </el-form-item>
          <el-form-item label="触发事件名称 ">
            <el-input v-model="listQuery.eventNames" placeholder="请输入触发事件名称 " />
          </el-form-item>
      ...
      <div class="table-container">
        ...
        <el-table v-loading="listLoading" :data="list" size="mini" element-loading-text="Loading" fit border highlight-current-row>
          ...
          <el-table-column v-if="columns[0].visible" label="通知编号 " prop="contentId" align="center" sortable :show-overflow-tooltip="true" />
          <el-table-column v-if="columns[1].visible" label="内容编码 " prop="contentCode" align="center" sortable :show-overflow-tooltip="true" />
          <el-table-column v-if="columns[2].visible" label="租户编号 " prop="tenantId" align="center" sortable :show-overflow-tooltip="true" />
          <el-table-column v-if="columns[3].visible" label="通知标题 " prop="messageTitle" align="center" sortable :show-overflow-tooltip="true" />
          <el-table-column v-if="columns[4].visible" label="通知内容 " prop="messageContent" align="center" sortable :show-overflow-tooltip="true" />
          <el-table-column v-if="columns[5].visible" label="通知类型 " prop="messageTypeCode" align="center" sortable :show-overflow-tooltip="true" />
          <el-table-column v-if="columns[6].visible" label="通知系统 " prop="messageSystemCode" align="center" sortable :show-overflow-tooltip="true" />
          <el-table-column v-if="columns[7].visible" label="通知平台  " prop="messagePlatform" align="center" sortable :show-overflow-tooltip="true" />
          <el-table-column v-if="columns[8].visible" label="流程编号 " prop="processId" align="center" sortable :show-overflow-tooltip="true" />
          <el-table-column v-if="columns[9].visible" label="是否为默认版本 " prop="defaultFalg" align="center" sortable :show-overflow-tooltip="true" />
          <el-table-column v-if="columns[10].visible" label="触发事件编码 " prop="eventCodes" align="center" sortable :show-overflow-tooltip="true" />
          <el-table-column v-if="columns[11].visible" label="触发事件名称 " prop="eventNames" align="center" sortable :show-overflow-tooltip="true" />
          <el-table-column v-if="columns[12].visible" label="排序 " prop="order" align="center" sortable :show-overflow-tooltip="true" />
          <el-table-column v-if="columns[13].visible" label="备注 " prop="remarks" align="center" sortable :show-overflow-tooltip="true" />
          <el-table-column v-if="columns[14].visible" label="状态" prop="validState" align="center">
            <template slot-scope="scope">
          ...
          <el-table-column v-if="columns[15].visible" label="操作人工号 " prop="operatorId" align="center" sortable :show-overflow-tooltip="true" />
          <el-table-column v-if="columns[16].visible" label="操作人工姓名 " prop="operatorName" align="center" sortable :show-overflow-tooltip="true" />
          <el-table-column v-if="columns[17].visible" label="创建时间" align="center">
            <template slot-scope="scope">
              <span>{{ scope.row.createTime }}</span>
            </template>
          </el-table-column>
          <el-table-column v-if="columns[18].visible" label="更新时间" align="center">
            <template slot-scope="scope">
      ...
      <el-dialog :title="titleMap[dialogStatus]" :visible.sync="dialogVisible" width="40%" @close="handleDialogClose">
        <el-form ref="dataForm" :model="form" :rules="rules" label-width="auto" class="demo-ruleForm">
          <el-form-item v-if="true" label="通知编号 :" prop="contentId">
            <el-input v-model="form.contentId" disabled />

          </el-form-item>
          <el-form-item v-if="true" label="内容编码 :" prop="contentCode">
            <el-input
          ...
          <el-form-item v-if="true" label="通知标题 :" prop="messageTitle">
            <el-input
              v-model="form.messageTitle"
              placeholder="请输入通知标题 "
            />
          </el-form-item>
          <el-form-item v-if="true" label="通知内容 :" prop="messageContent">
            <el-input
          ...
          <el-form-item v-if="true" label="通知类型 :" prop="messageTypeCode">
            <el-input
              v-model="form.messageTypeCode"
              placeholder="请输入通知类型 "
            />
          </el-form-item>
          <el-form-item v-if="true" label="通知系统 :" prop="messageSystemCode">
            <el-input
              v-model="form.messageSystemCode"
              placeholder="请输入通知系统 "
            />
          </el-form-item>
          <el-form-item v-if="true" label="通知平台  :" prop="messagePlatform">
            <el-input
          ...
          <el-form-item v-if="true" label="是否为默认版本 :" prop="defaultFalg">
            <el-input
              v-model="form.defaultFalg"
              placeholder="请输入是否为默认版本 "
            />
          </el-form-item>
          <el-form-item v-if="true" label="触发事件编码 :" prop="eventCodes">
            <el-input
              v-model="form.eventCodes"
              placeholder="请输入触发事件编码 "
            />
          </el-form-item>
          <el-form-item v-if="true" label="触发事件名称 :" prop="eventNames">
            <el-input
          ...
          <el-form-item v-if="false" label="操作人工姓名 :" prop="operatorName">
            <el-input
      ...
      <el-dialog :title="titleMap[dialogStatus]" :visible.sync="updateDialogVisible" width="40%" @close="handleDialogClose">
        <el-form ref="updateDataForm" :model="updateForm" :rules="updateRules" label-width="auto" class="demo-ruleForm">
          <el-form-item v-if="true" label="通知编号 :" prop="contentId">
            <el-input v-model="updateForm.contentId" disabled />
...
<script>
import { getMessageContentListPage, saveMessageContent, updateMessageContent, deleteById, download } from '@/api/system/messageContent'
...
export default {
  ...
  data() {
    return {
      ...
      columns: [
        ...
        { key: 6, value: 'messageSystemCode', label: '通知系统 ', visible: true },
        { key: 7, value: 'messagePlatform', label: '通知平台  ', visible: true },
        { key: 8, value: 'processId', label: '流程编号 ', visible: true },
        { key: 9, value: 'defaultFalg', label: '是否为默认版本 ', visible: true },
        ...
        { key: 16, value: 'operatorName', label: '操作人工姓名 ', visible: true },
  ...
  methods: {
    getList() {
      ...
      getMessageContentListPage(this.listQuery).then(response => {
        ...
        if (valid) {
          this.$confirm('确定操作吗?', '提示', {
            ...
            if (_this.dialogStatus === 'create') {
              saveMessageContent(_this.form).then(response => {
                if (response.code === 200) {
                  _this.getList()
              ...
              updateMessageContent(_this.updateForm).then(response => {
                if (response.code === 200) {
                  _this.getList()
                  _this.$message.success(response.message)
