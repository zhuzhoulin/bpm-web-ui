        ...
        >
          ...
          >
            ...
            <GeneratorCodemirror
              ...
              id="codemirror"
              ref="codemirror"
              :value.sync="updateTemplateForm.templateContent"
              :language.sync="language"
            />
          </el-form-item>
          <el-form-item
        ...
        >
          ...
          >
            ...
            <GeneratorCodemirror
              ...
              id="codemirror"
              ref="codemirror"
              :value.sync="saveTemplateForm.templateContent"
              :language.sync="language"
            />
          </el-form-item>
          <el-form-item
                ...
                .then((response) => {
                  if (response.code === 200) {
                    ...
                    param.outputFileName =
                      _this.updateTemplateForm.templateName
                    param.remarks = _this.updateTemplateForm.remarks
                    param.templateContent =
                      _this.updateTemplateForm.templateContent
                    param.templateGroupId = _this.updateForm.templateGroupId
