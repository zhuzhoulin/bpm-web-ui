...
import { is as _is, getExpandedBounds as _getExpandedBounds, getBendpoints as _getBendpoints } from './DiUtil';

var is = _is;
var getExpandedBounds = _getExpandedBounds;
var getBendpoints = _getBendpoints;
...
class AutoLayout {
  ...
  _buildTreeBreadFirstSearch(rootFlowElement) {
    var self = this;
  ...
  _explodeSubprocess(flowElement, flowElements) {
  ...
  _addTreeNode(flowElement, flowElements) {
  ...
  _balanceTreeNodeParentLevels(node) {
    var self = this;
  ...
  _layoutTreeBreadFirstSearch(parentFlowElement, rootDi) {
  ...
  _groupElement(elementOrConnection, group, parentDi) {
  ...
  _layoutConnections(group, parentDi) {
    var self = this;
    var createDi = this.DiFactory.createBpmnElementDi.bind(this.DiFactory);
